...
namespace HealthHarmony.SQL.Migrations
{
    ...
    [Migration("20231105132556_Add-DailySchedule-Table")]
    partial class AddDailyScheduleTable
    {
            ...
            modelBuilder.Entity("HealthHarmony.Models.Visits.Entities.DailySchedule", b =>
                {
                    b.HasOne("HealthHarmony.Models.Clinics.Entities.Clinic", "Clinic")
                        .WithOne()
                        .HasForeignKey("HealthHarmony.Models.Visits.Entities.DailySchedule", "ClinicId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HealthHarmony.Models.Doctors.Entities.Doctor", "Doctor")
                        .WithOne()
                        .HasForeignKey("HealthHarmony.Models.Visits.Entities.DailySchedule", "DoctorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("HealthHarmony.Models.Visits.Entities.Visit", b =>
                {
                    b.HasOne("HealthHarmony.Models.Clinics.Entities.Clinic", "Clinic")
                        .WithOne()
                        .HasForeignKey("HealthHarmony.Models.Visits.Entities.Visit", "ClinicId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HealthHarmony.Models.Doctors.Entities.Doctor", "Doctor")
                        .WithOne()
                        .HasForeignKey("HealthHarmony.Models.Visits.Entities.Visit", "DoctorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HealthHarmony.Models.Patients.Entities.Patient", "Patient")
                        .WithOne()
                        .HasForeignKey("HealthHarmony.Models.Visits.Entities.Visit", "PatientId")
                        .OnDelete(DeleteBehavior.Cascade);
